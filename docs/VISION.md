...
| 9 | **Compliance** | I stort klar | Append-only-revisionslogg via trigger (överlever t.o.m. raderat ärende), RLS 45/45 i två miljöer, oföränderliga meddelanden, obruten fakturaserie. Saknas: läsbar loggvy, beslutade gallringsregler (öppen juridisk fråga, noterad på `audit_events`). |
